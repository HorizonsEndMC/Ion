...
object ReminderManager : IonComponent() {
	private val messages = listOf(
		...
		"<$HE_MEDIUM_GRAY>Building a speeder (25-100 blocks) is an incredibly fast and easy way to travel around your base. Planet-side only.",
		...
		"<$HE_MEDIUM_GRAY>Lost everything? You can always purchase a new starter ship by visiting the ship dealer at any trade city.",
		...
		"<$HE_MEDIUM_GRAY>Pro tip: ship factories can also be used for printing buildings or infrastructure.".
