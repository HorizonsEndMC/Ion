package net.starlegacy.javautil.blockplacement;
...
public class BlockPlacementRaw {
	...
	public synchronized void queue(World world, Long2ObjectOpenHashMap<BlockState> queue) {
	...
	public void flush(@Nullable Consumer<World> onComplete) {
	...
	public void placeWorldQueue(World world, Long2ObjectOpenHashMap<BlockState[][][]> worldQueue, @Nullable Consumer<World> onComplete, boolean immediate) {
