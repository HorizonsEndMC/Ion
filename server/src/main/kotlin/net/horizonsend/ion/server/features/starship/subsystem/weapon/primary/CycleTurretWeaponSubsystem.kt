...
) : TurretWeaponSubsystem<CycleTurretBalancing, CycleTurretBalancing.CycleTurretProjectileBalancing>(ship, pos, face, ship.balancingManager.getSubsystemSupplier(CycleTurretWeaponSubsystem::class)) {
    override val inaccuracyRadians: Double get() = Math.toRadians(balancing.inaccuracyDegrees)
