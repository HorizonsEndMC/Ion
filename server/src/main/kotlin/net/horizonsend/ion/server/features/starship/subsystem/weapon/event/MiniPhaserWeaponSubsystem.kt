...
class MiniPhaserWeaponSubsystem(
    ...
    pos: Vec3i,
    face: BlockFace
) : CannonWeaponSubsystem<MiniPhaserBalancing>(starship, pos, face, starship.balancingManager.getSubsystemSupplier(MiniPhaserWeaponSubsystem::class)), AmmoConsumingWeaponSubsystem, PermissionWeaponSubsystem {
