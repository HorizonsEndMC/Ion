...
class WreckStructureRegistry : Registry<WreckStructure>(WRECK_STRUCTURE) {
	...
	override fun boostrap() {
		...
		register(WreckStructureKeys.TUTORIAL_ESCAPE_POD, SchematicWreckStructure(WreckStructureKeys.TUTORIAL_ESCAPE_POD, "TutorialEscapePod"))
		register(WreckStructureKeys.YACHT, SchematicWreckStructure(WreckStructureKeys.YACHT, "yacht"))
	}
}
