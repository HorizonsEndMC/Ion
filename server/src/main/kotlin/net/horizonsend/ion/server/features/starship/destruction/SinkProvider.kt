		...
		AI_LARGE {
			override fun getSinkProvider(starship: ActiveStarship): SinkProvider {
				return RemoveBlockSink.withChance(starship, mapOf(
					...
					CustomBlockWrapper(CustomBlocks.TITANIUM_BLOCK) to Pair(0.0, Always),
					CustomBlockWrapper(CustomBlocks.ALUMINUM_BLOCK) to Pair(0.0, Always),
					CustomBlockWrapper(CustomBlocks.URANIUM_BLOCK) to Pair(0.0, Always),
					CustomBlockWrapper(CustomBlocks.ENRICHED_URANIUM_BLOCK) to Pair(0.5, Always),
					CustomBlockWrapper(CustomBlocks.NETHERITE_CASING) to Pair(0.5, Always),
					CustomBlockWrapper(CustomBlocks.CHETHERITE_BLOCK) to Pair(0.0, Always),
					CustomBlockWrapper(CustomBlocks.STEEL_BLOCK) to Pair(0.5, Always),
		...
		PLAYER {
			override fun getSinkProvider(starship: ActiveStarship): SinkProvider {
				return RemoveBlockSink.withChance(starship, mapOf(
					...
					CustomBlockWrapper(CustomBlocks.TITANIUM_BLOCK) to Pair(0.5, IfPlayerSink),
					CustomBlockWrapper(CustomBlocks.ALUMINUM_BLOCK) to Pair(0.5, IfPlayerSink),
					CustomBlockWrapper(CustomBlocks.URANIUM_BLOCK) to Pair(0.5, IfPlayerSink),
					CustomBlockWrapper(CustomBlocks.ENRICHED_URANIUM_BLOCK) to Pair(0.75, IfPlayerSink),
					CustomBlockWrapper(CustomBlocks.NETHERITE_CASING) to Pair(0.75, IfPlayerSink),
					CustomBlockWrapper(CustomBlocks.CHETHERITE_BLOCK) to Pair(0.5, IfPlayerSink),
					CustomBlockWrapper(CustomBlocks.STEEL_BLOCK) to Pair(0.75, IfPlayerSink),
					CustomBlockWrapper(CustomBlocks.BARGE_REACTOR_CORE) to Pair(1.0, Always),
					CustomBlockWrapper(CustomBlocks.CRUISER_REACTOR_CORE) to Pair(1.0, Always),
					CustomBlockWrapper(CustomBlocks.BATTLECRUISER_REACTOR_CORE) to Pair(1.0, Always),
				))
