...
import net.horizonsend.ion.server.features.nations.gui.manageRolesGUI
import net.horizonsend.ion.server.features.nations.gui.memberRoleGUI
import net.horizonsend.ion.server.features.nations.gui.membersRoleGUI
...
internal abstract class RoleCommand<Parent : DbObject, Permission : Enum<Permission>, T : Role<Parent, Permission>> :
	net.horizonsend.ion.server.command.SLCommand() {
