...
object QuickdrawMod : ItemModification {
	...
	override val modItem: IonRegistryKey<CustomItem, out CustomItem> = CustomItemKeys.ARMOR_MODIFICATION_QUICKDRAW
	override val crouchingDisables: Boolean = false
	override val key = ItemModKeys.QUICKDRAW
	override val displayName: Component = ofChildren(
		Component.text("Quickdraw", NamedTextColor.RED),
