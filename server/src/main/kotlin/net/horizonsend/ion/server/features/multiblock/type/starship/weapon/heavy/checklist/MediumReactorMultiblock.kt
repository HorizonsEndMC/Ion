...
object MediumReactorMultiblock : AbstractReactorCore({ customBlock(CustomBlockKeys.MEDIUM_REACTOR_CORE.getValue()) }) {
	override val displayName: Component get() = text("Medium Reactor")
	override val description: Component get() = text("Reactor core critical to tech 2 Frigate and Destroyer functionality.")

	override val name: String = "medreactor"
	...
	override fun MultiblockShape.buildStructure() {
		...
		z(2) {
			...
			y(1) {
				...
				x(0).customBlock(CustomBlockKeys.MEDIUM_REACTOR_CORE.getValue())
