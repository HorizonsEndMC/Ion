...
class WreckStructure(override val key: IonRegistryKey<WreckStructure, out WreckStructure>, clipboardName: String) : Keyed<WreckStructure> {
	...
	fun getExtents(metaData: WreckMetaData): Pair<Vec3i, Vec3i> {
	...
	fun getLocalCoordinate(startOffsetX: Int, startOffsetY: Int, startOffsetZ: Int, metaData: WreckMetaData): BlockVector3 {
	...
	fun getBlockData(startOffsetX: Int, startOffsetY: Int, startOffsetZ: Int, metaData: WreckMetaData): BlockData {
	...
	fun getNBTData(startOffsetX: Int, startOffsetY: Int, startOffsetZ: Int, realX: Int, realY: Int, realZ: Int, metaData: WreckMetaData): CompoundTag? {
		val local = getLocalCoordinate(startOffsetX, startOffsetY, startOffsetZ, metaData)
	...
	fun isInBounds(startOffsetX: Int, startOffsetY: Int, startOffsetZ: Int, metaData: WreckMetaData): Boolean {
		val local = getLocalCoordinate(startOffsetX, startOffsetY, startOffsetZ, metaData)
