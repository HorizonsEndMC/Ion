...
) : TurretWeaponSubsystem<TriTurretBalancing, TriTurretBalancing.TriTurretProjectileBalancing>(ship, pos, face, ship.balancingManager.getWeaponSupplier(RapidHeavyMissileLauncherWeaponSubsystem::class)), HeavyWeaponSubsystem {
