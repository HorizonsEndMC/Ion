...
class SequencePhase(
	...
	val description: PhaseDescription? = null,
	...
	companion object {
		fun endSequence(sequenceKey: IonRegistryKey<Sequence, Sequence>, key: IonRegistryKey<SequencePhase, SequencePhase>, triggers: Collection<SequenceTrigger<*>>, description: PhaseDescription, vararg effect: SequencePhaseEffect): SequencePhase = SequencePhase(
			phaseKey = key,
