...
) : TurretWeaponSubsystem<HeavyTurretBalancing, HeavyTurretBalancing.HeavyTurretProjectileBalancing>(starship, pos, face, starship.balancingManager.getSubsystemSupplier(HeavyTurretWeaponSubsystem::class)) {
