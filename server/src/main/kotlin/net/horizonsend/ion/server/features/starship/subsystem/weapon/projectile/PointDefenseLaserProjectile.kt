...
class PointDefenseLaserProjectile(
	...
	shooter: Damager
) : LaserProjectile(starship, name, loc, dir, shooter, PointDefenseStarshipWeaponMultiblockSide.damageType) {
	override val balancing: StarshipWeapons.ProjectileBalancing = starship?.balancing?.weapons?.pointDefence ?: ConfigurationFiles.starshipBalancing().nonStarshipFired.pointDefence
