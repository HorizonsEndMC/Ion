...
class CustomTurretSubsystem(starship: Starship, pos: Vec3i, override var face: BlockFace, val multiblock: CustomTurretBaseMultiblock) : WeaponSubsystem<StarshipWeaponBalancing<*>>(starship, pos, starship.balancingManager.getWeaponSupplier()), DirectionalSubsystem {
	init {
