...
) : TurretWeaponSubsystem<LogisticsTurretBalancing, LogisticsTurretProjectileBalancing>(ship, pos, face, ship.balancingManager.getSubsystemSupplier(LogisticTurretWeaponSubsystem::class)) {
