...
object ExtensionBeltMod : ItemModification {
	...
	override val modItem: IonRegistryKey<CustomItem, out CustomItem> = CustomItemKeys.ARMOR_MODIFICATION_EXTENSION_BELT
	override val crouchingDisables: Boolean = false
	override val key = ItemModKeys.EXTENSION_BELT
	override val displayName: Component = ofChildren(
		Component.text("Extension Belt", NamedTextColor.RED),
