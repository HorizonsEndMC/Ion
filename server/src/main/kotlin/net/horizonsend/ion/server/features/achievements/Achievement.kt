...
enum class Achievement(
	...
	PLANET_KOVFEFE("It's not chocolate", "Visit: Kovfefe", 750, 125, 0, 210), // Astral
	...
	ACQUIRE_TITANIUM("Future's Material", "Obtain Titanium", 250, 100, 0, 403), // Gutin + Astral
	ACQUIRE_URANIUM("Split the atom", "Obtain Uranium", 250, 100, 0, 404), // Astral
	BUY_SPAWN_SHUTTLE("Space and beyond", "Buy a spawn shuttle", 250, 100, 0, 305), // Sciath + Astral
	...
	CREATE_SETTLEMENT("Breaking ground", "Found a settlement", 1000, 250, 0, 310), // Astral
	...
	KILL_PLAYER("Carried away", "Kill a player", 250, 100, 0, 311), // Astral
	...
	LEVEL_20("Where it begins", "Reach level 20", 2000, 350, 0, 314), // Kwazedilla + Astral
	LEVEL_40("Sorry for the pain", "Reach level 40", 5000, 500, 0, 315), // Sciath
	LEVEL_80("Overwhelming power", "Reach level 80", 10000, 1000, 0, 316), // Astral
