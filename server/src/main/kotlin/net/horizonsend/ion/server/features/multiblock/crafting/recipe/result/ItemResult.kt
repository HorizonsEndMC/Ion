...
interface ItemResult<E: ItemResultEnviornment> : RecipeResult<E> {
	...
	companion object {
		...
		fun <E: ItemResultEnviornment> simpleResult(material: Material, amount: Int = 1): SimpleResult<E> = SimpleResult(ItemStack(material, amount))
	}
	...
	class SimpleResult<E: ItemResultEnviornment>(private val item: ItemStack) : ItemResult<E> {
		...
		override fun getResultItem(enviornment: E): ItemStack = item.clone()
