			...
			terrainGenerationSettings = FeatureGeneratorConfiguration(features = setOf(
				AsteroidPlacementConfiguration(
					...
					selector = AsteroidPlacementConfiguration.AsteroidSelectorCondition.WeightedRandom(listOf(
						...
						AsteroidPlacementConfiguration.AsteroidSelectorCondition.BuilderReference("TRENCH_ALUMINUM") to 7.0,
						AsteroidPlacementConfiguration.AsteroidSelectorCondition.BuilderReference("TRENCH_DIAMOND") to 7.0,
			...
			terrainGenerationSettings = FeatureGeneratorConfiguration(features = setOf(
				AsteroidPlacementConfiguration(
					...
					selector = AsteroidPlacementConfiguration.AsteroidSelectorCondition.WeightedRandom(listOf(
						...
						AsteroidPlacementConfiguration.AsteroidSelectorCondition.BuilderReference("MINING_WORLD_DIAMOND") to 7.0,
