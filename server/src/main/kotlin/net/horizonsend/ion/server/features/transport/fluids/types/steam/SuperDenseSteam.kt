...
object SuperDenseSteam : GasFluid(
	...
	override fun getHeatingResult(stack: FluidStack, resultContainer: FluidStorageContainer, appliedEnergyJoules: Double, maximumTemperature: Double, location: Location?): HeatingResult {
		...
		val tempStack = FluidTypeKeys.ULTRA_DENSE_STEAM.getValue().getDensity(FluidStack(FluidTypeKeys.ULTRA_DENSE_STEAM, 1.0), location)
		...
		val steamStack = FluidStack(FluidTypeKeys.ULTRA_DENSE_STEAM, steamVolume)
	...
	private const val CONVERSION_POINT = 600.0
	private const val CONVERSION_COST = 2257.0 * 4
}
