...
abstract class CombatModule(controller: AIController, val targetingSupplier: Supplier<AITarget?>) : net.horizonsend.ion.server.features.ai.module.AIModule(controller) {
