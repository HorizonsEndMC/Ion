...
class InterceptorCannonWeaponSubsystem(
	...
	pos: Vec3i,
	face: BlockFace,
) : CannonWeaponSubsystem<InterceptorCannonBalancing>(starship, pos, face, starship.balancingManager.getSubsystemSupplier(InterceptorCannonWeaponSubsystem::class)) {
