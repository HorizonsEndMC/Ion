...
) : WeaponSubsystem<StarshipWeapons.DisintegratorBeamBalancing>(starship, pos, starship.balancingManager.getSupplier()), DirectionalSubsystem, ManualWeaponSubsystem {
