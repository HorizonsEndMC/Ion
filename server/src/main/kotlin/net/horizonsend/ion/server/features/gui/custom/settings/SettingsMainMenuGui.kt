...
class SettingsMainMenuGui(player: Player) : SettingsPageGui(player, "Settings") {
    ...
    override val buttonsList = listOf(
		...
		createSettingsPage(player, "Other Settings",
			...
			DBCachedBooleanToggle(text("Share My Location To Allies"), "Allows allied and same-nation players to retrieve your location with /getpos.", GuiItem.COMPASS_NEEDLE, false, PlayerSettings::shareLocationToAllies),
