...
class SettingsMainMenuGui(player: Player) : SettingsPageGui(player, "Settings") {
    ...
    override val buttonsList = listOf(
		createSettingsPage(player, "Control Settings",
			...
			DBCachedBooleanToggle(text("Alt. Light/Heavy Weapon Keys"), "Alternates the firing controls for light and heavy weapons.", GuiItem.LIST, false, PlayerSettings::alternateFireButtons),
		),
