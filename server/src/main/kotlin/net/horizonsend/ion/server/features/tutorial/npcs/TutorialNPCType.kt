...
import net.horizonsend.ion.server.features.starship.ai.spawning.explorer.EXPLORER_MEDIUM_CYAN
import net.horizonsend.ion.server.features.starship.ai.spawning.miningcorp.MINING_CORP_LIGHT_ORANGE
