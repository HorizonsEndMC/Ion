...
class HeavyLaserWeaponSubsystem(
    ...
    pos: Vec3i,
    face: BlockFace
) : TargetTrackingCannonWeaponSubsystem<HeavyLaserBalancing>(starship, pos, face, starship.balancingManager.getSubsystemSupplier(HeavyLaserWeaponSubsystem::class)), HeavyWeaponSubsystem, AmmoConsumingWeaponSubsystem {
