...
import net.horizonsend.ion.server.features.ai.faction.AIFaction.Companion.EXPLORER_MEDIUM_CYAN
import net.horizonsend.ion.server.features.ai.faction.AIFaction.Companion.MINING_CORP_DARK_ORANGE
import net.horizonsend.ion.server.features.ai.faction.AIFaction.Companion.MINING_CORP_LIGHT_ORANGE
import net.horizonsend.ion.server.features.ai.faction.AIFaction.Companion.PIRATE_LIGHT_RED
import net.horizonsend.ion.server.features.ai.faction.AIFaction.Companion.PIRATE_SATURATED_RED
import net.horizonsend.ion.server.features.ai.faction.AIFaction.Companion.PRIVATEER_DARK_TEAL
import net.horizonsend.ion.server.features.ai.faction.AIFaction.Companion.PRIVATEER_LIGHT_TEAL
import net.horizonsend.ion.server.features.ai.faction.AIFaction.Companion.PRIVATEER_MEDIUM_TEAL
import net.horizonsend.ion.server.features.ai.faction.AIFaction.Companion.TSAII_DARK_ORANGE
import net.horizonsend.ion.server.features.ai.faction.AIFaction.Companion.TSAII_VERY_DARK_ORANGE
