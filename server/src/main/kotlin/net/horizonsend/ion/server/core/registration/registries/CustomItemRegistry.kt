...
class CustomItemRegistry : Registry<CustomItem>(RegistryKeys.CUSTOM_ITEMS) {
	...
	private fun registerIndustry() {
		...
		unStackable(key = CustomItemKeys.GAUSS_CANNON_AMMO_UNLOADED, model = "industry/gauss_cannon_ammo_unloaded", displayName = Component.text("Unloaded Gauss Cannon Ammo"))
		stackable(key = CustomItemKeys.GAUSS_CANNON_AMMO_LOADED, model = "industry/gauss_cannon_ammo_loaded", displayName = Component.text("Loaded Gauss Cannon Ammo"))
		unStackable(key = CustomItemKeys.WEBIFIER_AMMO_UNLOADED, model = "industry/webifier_ammo_unloaded", displayName = Component.text("Unloaded Webifier Ammo"))
		stackable(key = CustomItemKeys.WEBIFIER_AMMO_LOADED, model = "industry/webifier_ammo_loaded", displayName = Component.text("Loaded Webifier Ammo"))
		unStackable(key = CustomItemKeys.NEUTRALIZER_AMMO_UNLOADED, model = "industry/neutralizer_ammo_unloaded", displayName = Component.text("Unloaded Neutralizer Ammo"))
		stackable(key = CustomItemKeys.NEUTRALIZER_AMMO_LOADED, model = "industry/neutralizer_ammo_loaded", displayName = Component.text("Loaded Neutralizer Ammo"))
		unStackable(key = CustomItemKeys.ASSAULT_TURRET_AMMO_UNLOADED, model = "industry/assault_turret_ammo_unloaded", displayName = Component.text("Unloaded Assault Turret Ammo"))
		stackable(key = CustomItemKeys.ASSAULT_TURRET_AMMO_LOADED, model = "industry/assault_turret_ammo_loaded", displayName = Component.text("Loaded Assault Turret Ammo"))
		unStackable(key = CustomItemKeys.ACAP_TURRET_AMMO_UNLOADED, model = "industry/acap_turret_ammo_unloaded", displayName = Component.text("Unloaded ACAP Turret Ammo"))
		stackable(key = CustomItemKeys.ACAP_TURRET_AMMO_LOADED, model = "industry/acap_turret_ammo_loaded", displayName = Component.text("Loaded ACAP Turret Ammo"))
		unStackable(key = CustomItemKeys.DOOMSDAY_LASER_AMMO_UNLOADED, model = "industry/doomsday_laser_ammo_unloaded", displayName = Component.text("Unloaded Doomsday Laser Ammo"))
		stackable(key = CustomItemKeys.DOOMSDAY_LASER_AMMO_LOADED, model = "industry/doomsday_laser_ammo_loaded", displayName = Component.text("Loaded Doomsday Laser Ammo"))
