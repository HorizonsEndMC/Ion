...
class CustomItemRegistry : Registry<CustomItem>(RegistryKeys.CUSTOM_ITEMS) {
	...
	private fun registerIndustry() {
		...
		unStackable(key = CustomItemKeys.BREACHER_SHELL_UNLOADED, model = "industry/breacher_shell_unloaded", displayName = Component.text("Unloaded Breacher Shell"))
		...
		unStackable(key = CustomItemKeys.STASIS_CHARGE_UNLOADED, model = "industry/stasis_charge_unloaded", displayName = Component.text("Uncharged Stasis Charge"))
		...
		unStackable(key = CustomItemKeys.ENTROPIC_CHARGE_UNLOADED, model = "industry/entropic_charge_unloaded", displayName = Component.text("Uncharged Entropic Charge"))
		...
		unStackable(key = CustomItemKeys.HELIX_SHELL_UNLOADED, model = "industry/helix_shell_unloaded", displayName = Component.text("Unloaded Helix Shell"))
		stackable(key = CustomItemKeys.HELIX_SHELL_LOADED, model = "industry/helix_shell_loaded", displayName = Component.text("Helix Shell"))
		unStackable(key = CustomItemKeys.SIEGE_SHELL_UNLOADED, model = "industry/siege_shell_unloaded", displayName = Component.text("Unloaded Siege Shell"))
		stackable(key = CustomItemKeys.SIEGE_SHELL_LOADED, model = "industry/siege_shell_loaded", displayName = Component.text("Siege Shell"))
		unStackable(key = CustomItemKeys.STELLAR_PRISM_UNLOADED, model = "industry/stellar_prism_unloaded", displayName = Component.text("Uncharged Stellar Prism"))
