...
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ADVANCED_ITEM_EXTRACTOR
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ALUMINUM_BLOCK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ALUMINUM_INGOT
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ALUMINUM_ORE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ARMOR_MODIFICATION_ENVIRONMENT
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ARMOR_MODIFICATION_NIGHT_VISION
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ARMOR_MODIFICATION_PRESSURE_FIELD
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ARMOR_MODIFICATION_ROCKET_BOOSTING
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ARMOR_MODIFICATION_SHOCK_ABSORBING
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ARMOR_MODIFICATION_SPEED_BOOSTING
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.BARGE_REACTOR_CORE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.BATTERY_A
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.BATTERY_G
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.BATTERY_M
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.BATTLECRUISER_REACTOR_CORE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.BLASTER_CANNON
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.BLASTER_PISTOL
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.BLASTER_RIFLE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.BLASTER_SHOTGUN
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.BLASTER_SNIPER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.CANNON_RECEIVER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.CHETHERITE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.CHETHERITE_BLOCK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.CIRCUITRY
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.CIRCUIT_BOARD
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.CRATE_PLACER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.CRUISER_REACTOR_CORE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.DETONATOR
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ENERGY_SWORD_BLUE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ENERGY_SWORD_GREEN
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ENERGY_SWORD_ORANGE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ENERGY_SWORD_PINK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ENERGY_SWORD_PURPLE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ENERGY_SWORD_RED
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ENERGY_SWORD_YELLOW
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ENRICHED_URANIUM
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ENRICHED_URANIUM_BLOCK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.FABRICATED_ASSEMBLY
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.FUEL_CELL
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.FUEL_CONTROL
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.FUEL_ROD_CORE
...
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.GAS_CANISTER_OXYGEN
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.GUN_BARREL
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.ITEM_FILTER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.MOTHERBOARD
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.MULTIBLOCK_WORKBENCH
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.NETHERITE_CASING
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.PISTOL_RECEIVER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_ARMOR_BOOTS
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_ARMOR_CHESTPLATE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_ARMOR_HELMET
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_ARMOR_LEGGINGS
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_CHAINSAW_ADVANCED
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_CHAINSAW_BASIC
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_CHAINSAW_ENHANCED
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_DRILL_ADVANCED
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_DRILL_BASIC
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_DRILL_ENHANCED
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_HOE_ADVANCED
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_HOE_BASIC
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.POWER_HOE_ENHANCED
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.RAW_ALUMINUM
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.RAW_ALUMINUM_BLOCK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.RAW_TITANIUM
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.RAW_TITANIUM_BLOCK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.RAW_URANIUM
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.RAW_URANIUM_BLOCK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.REACTIVE_ASSEMBLY
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.REACTIVE_CHASSIS
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.REACTIVE_COMPONENT
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.REACTIVE_HOUSING
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.REACTIVE_MEMBRANE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.REACTIVE_PLATING
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.REACTOR_CONTROL
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.REACTOR_FRAME
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.REINFORCED_FRAME
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.RIFLE_RECEIVER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.SHOTGUN_RECEIVER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.SMB_RECEIVER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.SMOKE_GRENADE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.SNIPER_RECEIVER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.SPECIAL_MAGAZINE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.STANDARD_MAGAZINE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.STEEL_ASSEMBLY
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.STEEL_BLOCK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.STEEL_CHASSIS
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.STEEL_INGOT
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.STEEL_MODULE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.STEEL_PLATE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.SUBMACHINE_BLASTER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.SUPERCONDUCTOR
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.SUPERCONDUCTOR_BLOCK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.SUPERCONDUCTOR_CORE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TITANIUM_BLOCK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TITANIUM_INGOT
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TITANIUM_ORE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_AUTO_COMPOST
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_AUTO_REPLANT
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_AUTO_SMELT
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_EXTENDED_BAR
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_FERTILIZER_DISPENSER
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_FORTUNE_1
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_FORTUNE_2
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_FORTUNE_3
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_POWER_CAPACITY_25
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_POWER_CAPACITY_50
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_RANGE_1
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_RANGE_2
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_RANGE_3
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_SILK_TOUCH_MOD
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.TOOL_MODIFICATION_VEIN_MINER_25
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.UNCHARGED_SHELL
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.UNLOADED_ARSENAL_MISSILE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.UNLOADED_SHELL
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.URANIUM
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.URANIUM_BLOCK
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.URANIUM_CORE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.URANIUM_ORE
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.URANIUM_ROD
import net.horizonsend.ion.server.core.registries.keys.CustomItemKeys.WRENCH
...
object Crafting : IonServerComponent() {
	override fun onEnable() {
		...
		shaped("power_capacity_50_modifier", TOOL_MODIFICATION_POWER_CAPACITY_50.getValue().constructItemStack()) {
			...
			setIngredient('s', STEEL_PLATE.getValue().constructItemStack())
		...
		shaped("extended_bar_modifier", TOOL_MODIFICATION_EXTENDED_BAR.getValue().constructItemStack()) {
			...
			setIngredient('s', STEEL_PLATE.getValue().constructItemStack())
			setIngredient('t', TITANIUM_INGOT.getValue().constructItemStack())
			setIngredient('c', STEEL_CHASSIS.getValue().constructItemStack())
		}
		...
		shaped("aoe_2_modifier", TOOL_MODIFICATION_RANGE_2.getValue().constructItemStack()) {
			...
			setIngredient('i', ExactChoice(STEEL_BLOCK.getValue().constructItemStack()))
			setIngredient('p', PISTON)
		...
		shaped("vein_miner_modifier", TOOL_MODIFICATION_VEIN_MINER_25.getValue().constructItemStack()) {
			...
			setIngredient('i', ExactChoice(ALUMINUM_BLOCK.getValue().constructItemStack()))
		...
		registerPowerArmorModule(ARMOR_MODIFICATION_PRESSURE_FIELD, RecipeChoice.ExactChoice(GAS_CANISTER_EMPTY.getValue().constructItemStack()))
