...
class AtmosphericGasRegistry : Registry<Gas>("ATMOSPHERIC_GASSES") {
	...
	override fun boostrap() {
		register(AtmosphericGasKeys.HYDROGEN, GasFuel(
			identifier = "HYDROGEN",
		...
		register(AtmosphericGasKeys.NITROGEN, GasFuel(
			identifier = "NITROGEN",
		...
		register(AtmosphericGasKeys.METHANE, GasFuel(
			identifier = "METHANE",
		...
		register(AtmosphericGasKeys.OXYGEN, GasOxidizer(
			identifier = "OXYGEN",
		...
		register(AtmosphericGasKeys.CHLORINE, GasOxidizer(
			identifier = "CHLORINE",
		...
		register(AtmosphericGasKeys.FLUORINE, GasOxidizer(
			identifier = "FLUORINE",
		...
		register(AtmosphericGasKeys.HELIUM, Gas(
			identifier = "HELIUM",
		...
		register(AtmosphericGasKeys.CARBON_DIOXIDE, Gas(
