...
object CapitalShieldCommandBurstMultiblock : AbstractCommandBurstMultiblock(Material.SEA_LANTERN ) {
	override val displayName: Component get() = text("Capital Shield Burst")
	override val description: Component get() = text("AOE Shield Pulse")

	override val name: String = "capshieldburst"
	...
	override fun createSubsystem(starship: Starship, sign: Sign, multiblock: Multiblock): AbstractCommandBurstSubsystem<*> {
		return CapitalShieldCommandBurstSubsystem(starship, sign, this)
	}
}
