...
//						"<$EXPLORER_LIGHT_CYAN>Rookie <$EXPLORER_MEDIUM_CYAN>Pilot" to 3,
					...
					ships = mapOf(
						nimble.identifier to 12,
						striker.identifier to 6,
				...
				AISpawningConfiguration.AISpawnerTier(
					...
					ships = mapOf(
						minhaulCheth.identifier to 9,
						minhaulRedstone.identifier to 7,
						minhaulTitanium.identifier to 6,
						exotranChetherite.identifier to 2,
						exotranRedstone.identifier to 2,
						exotranTitanium.identifier to 2,
						wayfinder.identifier to 6,
						striker.identifier to 12,
						amph.identifier to 6,
					)
				),
				AISpawningConfiguration.AISpawnerTier(
					identifier = "MEDIUM",
					...
					ships = mapOf(
						...
						exotranRedstone.identifier to 2,
						exotranTitanium.identifier to 2,
						dessle.identifier to 6,
						nimble.identifier to 6,
						wayfinder.identifier to 12,
						striker.identifier to 9,
						amph.identifier to 6,
					)
				),
				AISpawningConfiguration.AISpawnerTier(
