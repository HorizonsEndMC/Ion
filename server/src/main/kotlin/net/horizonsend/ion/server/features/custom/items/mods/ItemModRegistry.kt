...
object ItemModRegistry {
	...
	val FORTUNE_1 = registerMod(FortuneModifier(0, text("Fortune Modifier 0")))
	val FORTUNE_2 = registerMod(FortuneModifier(1, text("Fortune Modifier 1")))
	val FORTUNE_3 = registerMod(FortuneModifier(2, text("Fortune Modifier 2")))

	val POWER_CAPACITY_25 = registerMod(PowerCapacityIncrease(25_000, text("Power Capacity Upgrade 25_000")))
	val POWER_CAPACITY_50 = registerMod(PowerCapacityIncrease(50_000, text("Power Capacity Upgrade 50_000")))
