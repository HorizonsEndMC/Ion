...
object PlatePressMultiblock : Multiblock(), PoweredMultiblock<PlatePressMultiblock.PlatePressMultiblockEntity> {
	...
	) : MultiblockEntity(manager, PlatePressMultiblock, x, y, z, world, structureDirection), LegacyMultiblockEntity, PoweredMultiblockEntity {
		override val powerStorage: PowerStorage = loadStoredPower(data)
		override val multiblock: PlatePressMultiblock = PlatePressMultiblock
