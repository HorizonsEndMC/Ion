...
enum class StarshipType(
	...
	LIGHT_BARGE(
		displayName = "Light Barge",
		icon = SidebarIcon.LIGHT_BARGE_ICON.text,
		minSize = 12000,
		maxSize = 16000,
		minLevel = 70,
		concretePercent = 0.25,
		...
		crateLimitMultiplier = 1.0,
		menuItemRaw = { ItemStack(Material.JACK_O_LANTERN) },
		menuSubclasses = { listOf(AI_LIGHT_BARGE) },
		typeCategory = TypeCategory.TRADE_SHIP,
		color = "#066ef4",
		dynmapIcon = "light_barge",
		maxMiningLasers = 8,
		miningLaserTier = 4,
		overridePermission = "ion.ships.override.70",
		sinkProvider = SinkProvider.SinkProviders.PLAYER,
		balancingSupplier = ConfigurationFiles.starshipBalancing()::lightBarge
	),
	AI_LIGHT_BARGE(
		displayName = "Light Barge",
		icon = SidebarIcon.LIGHT_BARGE_ICON.text,
		...
		miningLaserTier = 4,
		concretePercent = 0.0,
		overridePermission = "ion.ships.ai.light_barge",
		sinkProvider = SinkProvider.SinkProviders.AI_LARGE,
		balancingSupplier = ConfigurationFiles.starshipBalancing()::lightBarge
	),
	BARGE(
