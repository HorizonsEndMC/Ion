...
enum class StarshipType(
	...
	menuItem: ItemStack,
	val menuSubclasses: Supplier<Iterable<StarshipType>> = Supplier { listOf() },
	...
	SPEEDER(
		...
		menuItem = ItemStack(Material.DEAD_BUSH),
		isWarship = false,
		color = "#ffff32",
	...
	AI_SPEEDER(
		...
		crateLimitMultiplier = 0.125,
		menuItem = ItemStack(Material.SPONGE),
		isWarship = false,
		color = "#ffff32",
		powerOverrider = 0.0,
		concretePercent = 0.0,
	...
	STARFIGHTER(
		...
		menuItem = ItemStack(Material.IRON_NUGGET),
		isWarship = true,
		color = "#ff8000",
		overridePermission = "ion.ships.override.1",
	...
	GUNSHIP(
		...
		containerPercent = 0.025,
		crateLimitMultiplier = 0.5,
		menuItem = ItemStack(Material.IRON_INGOT),
		isWarship = true,
		color = "#ff4000",
	...
	CORVETTE(
		...
		containerPercent = 0.025,
		crateLimitMultiplier = 0.5,
		menuItem = ItemStack(Material.IRON_BLOCK),
		isWarship = true,
		color = "#ff0000",
	...
	FRIGATE(
		...
		containerPercent = 0.025,
		crateLimitMultiplier = 0.5,
		menuItem = ItemStack(Material.LAPIS_BLOCK),
		isWarship = true,
		color = "#c00000",
	...
	DESTROYER(
		...
		containerPercent = 0.025,
		crateLimitMultiplier = 0.5,
		menuItem = ItemStack(Material.GOLD_BLOCK),
		isWarship = true,
		color = "#800000",
	...
	CRUISER(
		...
		containerPercent = 0.025,
		crateLimitMultiplier = 0.5,
		menuItem = ItemStack(Material.COPPER_BLOCK),
		isWarship = true,
		color = "#FFD700",
	...
	BATTLECRUISER(
		...
		menuItem = ItemStack(Material.DIAMOND_BLOCK),
		isWarship = true,
		color = "#0c5ce8",
	...
	BATTLESHIP(
		...
		crateLimitMultiplier = 0.5,
		menuItem = ItemStack(Material.EMERALD_BLOCK),
		isWarship = true,
		color = "#0c1cff",
	...
	DREADNOUGHT(
		...
		containerPercent = 0.015,
		crateLimitMultiplier = 0.5,
		menuItem = ItemStack(Material.NETHERITE_BLOCK),
		isWarship = true,
		color = "#320385",
	...
	SHUTTLE(
		...
		menuItem = ItemStack(Material.PRISMARINE_SHARD),
		isWarship = false,
		color = "#008033",
		overridePermission = "ion.ships.override.1",
		powerOverrider = 0.7,
	...
	TRANSPORT(
		...
		containerPercent = 0.045,
		crateLimitMultiplier = 1.0,
		menuItem = ItemStack(Material.PRISMARINE_CRYSTALS),
		isWarship = false,
		color = "#008066",
		overridePermission = "ion.ships.override.10",
		powerOverrider = 0.7,
	...
	LIGHT_FREIGHTER(
		...
		containerPercent = 0.045,
		crateLimitMultiplier = 1.0,
		menuItem = ItemStack(Material.PRISMARINE_SLAB),
		isWarship = false,
		color = "#008099",
		overridePermission = "ion.ships.override.20",
		powerOverrider = 0.7,
	...
	MEDIUM_FREIGHTER(
		...
		containerPercent = 0.045,
		crateLimitMultiplier = 1.0,
		menuItem = ItemStack(Material.PRISMARINE_STAIRS),
		isWarship = false,
		color = "#0080cc",
		powerOverrider = 0.7,
		maxMiningLasers = 4,
	...
	HEAVY_FREIGHTER(
		...
		containerPercent = 0.045,
		crateLimitMultiplier = 1.0,
		menuItem = ItemStack(Material.PRISMARINE),
		isWarship = false,
		color = "#0080ff",
		overridePermission = "ion.ships.override.60",
		powerOverrider = 0.7,
	...
	BARGE(
		...
		crateLimitMultiplier = 0.0,
		menuItem = ItemStack(Material.SEA_LANTERN),
		isWarship = false,
		color = "#0c5ce8",
		dynmapIcon = "barge",
		maxMiningLasers = 10,
	...
	PLATFORM(
		...
		concretePercent = 0.0,
		menuItem = ItemStack(Material.BEDROCK),
		isWarship = false,
			color = "#ffffff",
			overridePermission = "ion.ships.override.1",
			powerOverrider = 0.0,
	...
	UNIDENTIFIEDSHIP(
		...
		concretePercent = 0.0,
		crateLimitMultiplier = 100.0,
		menuItem = ItemStack(Material.MUD_BRICKS),
		isWarship = true,
		color = "#d0e39d",
	...
	AI_SHIP(
		...
		concretePercent = 0.0,
		crateLimitMultiplier = 0.5,
		menuItem = ItemStack(Material.SCULK),
		isWarship = true,
		color = "#d000d0",
	...
	val menuItem: ItemStack = ItemStack(menuItem)
