...
class SequenceTrigger<T : SequenceTriggerType.TriggerSettings>(val type: SequenceTriggerType<T>, val settings: T, private var triggerResult: (Player, TriggerContext) -> Unit) {
