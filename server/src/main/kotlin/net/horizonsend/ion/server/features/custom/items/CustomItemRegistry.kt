...
object CustomItemRegistry : IonServerComponent() {
	...
	val LIGHT_BARGE_REACTOR_CORE: CustomBlockItem = customBlockItem(identifier = "LIGHT_BARGE_REACTOR_CORE", model = "starship/light_barge_reactor_core", displayName = text("Light Barge Reactor Core", NamedTextColor.WHITE, BOLD), customBlock = CustomBlocks::LIGHT_BARGE_REACTOR_CORE)
