...
object CustomItemKeys : KeyRegistry<CustomItem>(RegistryKeys.CUSTOM_ITEMS, CustomItem::class) {
	...
	val GAUSS_CANNON_AMMO_UNLOADED = registerKey("GAUSS_CANNON_AMMO_UNLOADED")
	val GAUSS_CANNON_AMMO_LOADED = registerKey("GAUSS_CANNON_AMMO_LOADED")
	val WEBIFIER_AMMO_UNLOADED = registerKey("WEBIFIER_AMMO_UNLOADED")
	val WEBIFIER_AMMO_LOADED = registerKey("WEBIFIER_AMMO_LOADED")
	val NEUTRALIZER_AMMO_UNLOADED = registerKey("NEUTRALIZER_AMMO_UNLOADED")
	val NEUTRALIZER_AMMO_LOADED = registerKey("NEUTRALIZER_AMMO_LOADED")
	val ASSAULT_TURRET_AMMO_UNLOADED = registerKey("ASSAULT_TURRET_AMMO_UNLOADED")
	val ASSAULT_TURRET_AMMO_LOADED = registerKey("ASSAULT_TURRET_AMMO_LOADED")
	val ACAP_TURRET_AMMO_UNLOADED = registerKey("ACAP_TURRET_AMMO_UNLOADED")
	val ACAP_TURRET_AMMO_LOADED = registerKey("ACAP_TURRET_AMMO_LOADED")
	val DOOMSDAY_LASER_AMMO_UNLOADED = registerKey("DOOMSDAY_LASER_AMMO_UNLOADED")
	val DOOMSDAY_LASER_AMMO_LOADED = registerKey("DOOMSDAY_LASER_AMMO_LOADED")
