...
class EMPMissileStarshipWeaponSubsystem(
    starship: ActiveStarship,
    pos: Vec3i,
    override var face: BlockFace,
    private val multiblock: EMPMissileStarshipWeaponMultiblock
) : BalancedWeaponSubsystem<EMPMissileBalancing>(starship, pos, starship.balancingManager.getWeaponSupplier(EMPMissileStarshipWeaponSubsystem::class)), HeavyWeaponSubsystem, ManualWeaponSubsystem, DirectionalSubsystem, AmmoConsumingWeaponSubsystem {
	...
	override fun getName(): Component {
		return Component.text("EMP Missile")
	}
