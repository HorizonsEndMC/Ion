...
enum class Achievement(
	...
	SYSTEM_ASTERI     ("New beginnings"        , "Visit the Asteri system."             ,  2500,  400, 0), // Gutin
	SYSTEM_REGULUS    ("Middle Ground"         , "Visit the Regulus system."            ,  2500,  400, 0), // Sciath
	SYSTEM_SIRIUS     ("Why So Sirius?"        , "Visit the Sirius system."             ,  2500,  400, 0), // Sciath
	SYSTEM_ILIOS      ("Not the planet"        , "Visit the Ilios system."              ,  2500,  400, 0), // Kwazedilla
	...
	USE_HYPERSPACE    ("Ludicrous Speed!"      , "Use hyperspace to jump to a location.",   250,   75, 8), // Liluzivirt
	...
	BUY_SPAWN_SHUTTLE ("To space and beyond"   , "Buy a spawn shuttle from the dealer." ,   250,  100, 0)  // Sciath
}