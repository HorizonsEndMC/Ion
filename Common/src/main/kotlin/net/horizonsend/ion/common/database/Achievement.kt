...
enum class Achievement(
	...
	PLANET_AERACH     ("Aerach really rocks!"  , "Visit: Aerach"                 ,   750,  125, 0, true), // Kwazedilla
	PLANET_ARET       ("I hate sand"           , "Visit: Aret"                   ,   750,  125, 0, true), // Wither
	PLANET_CHANDRA    ("One small step"        , "Visit: Chandra"                ,   750,  125, 0, true), // Wither
	PLANET_CHIMGARA   ("Dont get tripophobia"  , "Visit: Chimgara"               ,   750,  125, 0, true), // Gutin
	PLANET_DAMKOTH    ("The cheth must flow"   , "Visit: Damkoth"                ,   750,  125, 0, true), // Wither
	PLANET_GAHARA     ("Ice Ice baby"          , "Visit: Gahara"                 ,   750,  125, 0, true), // Sciath
	PLANET_HERDOLI    ("The red planet"        , "Visit: Herdoli"                ,   750,  125, 0, true), // Wither
	PLANET_ILIUS      ("Welcome to HE!"        , "Visit: Ilius"                  ,   750,  125, 0, true), // Vandrayk
	PLANET_ISIK       ("Ashes to Ashes.."      , "Visit: Isik"                   ,   750,  125, 0, true), // Kwazedilla
	PLANET_KOVFEFE    ("It's not chocolate"    , "Visit: Kovfefe"                ,   750,  125, 0, true), // Peter
	PLANET_KRIO       ("Snowball fight"        , "Visit: Krio"                   ,   750,  125, 0, true), // Vandrayk
	PLANET_LIODA      ("Caves and Cliffs"      , "Visit: Lioda"                  ,   750,  125, 0, true), // Vandrayk
	PLANET_LUXITERNA  ("Supercritical"         , "Visit: Luxiterna"              ,   750,  125, 0, true), // Gutin
	PLANET_QATRA      ("What happened here"    , "Visit: Qatra"                  ,   750,  125, 0, true), // GenBukkit
	PLANET_RUBACIEA   ("Icy-Hot"               , "Visit: Rubaciea"               ,   750,  125, 0, true), // Liluzivirt
	PLANET_TURMS      ("Turms and Conditions"  , "Visit: Turms"                  ,   750,  125, 0, true), // Kwazedilla
	PLANET_VASK       ("Ooh! A penny!"         , "Visit: Vask"                   ,   750,  125, 0, true), // Vandrayk
