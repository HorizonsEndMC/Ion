...
internal object NationAdminCommand : SLCommand() {
    ...
    fun onStationSetLocaiton(sender: CommandSender, station: String, world: World, x: Int, z: Int) = asyncCommand(sender) {
        val spaceStation = SpaceStation.findOne(SpaceStation::name eq station)
            ?: fail { "Station $station not found" }
        SpaceStation.updateById(spaceStation._id, set(SpaceStation::world setTo world.name, SpaceStation::x setTo x, SpaceStation::z setTo z))
