...
import net.horizonsend.ion.common.utils.text.colors.PresetColor.Companion.presetColor
import net.kyori.adventure.text.format.TextColor

val DANGEROUS_PROMPT = presetColor("#FC0373")
val RISKY_PROMPT = presetColor("#FCBA03")
val SAFE_PROMPT = presetColor("#03FC7F")
