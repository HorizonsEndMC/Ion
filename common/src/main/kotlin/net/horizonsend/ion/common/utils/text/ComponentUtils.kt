...
const val QUEST_OBJECTIVE_ICON = '\uF8E0'
const val STARFIGHTER_ICON = '\uF8DF'
const val GUNSHIP_ICON = '\uF8DE'
const val CORVETTE_ICON = '\uF8DD'
const val FRIGATE_ICON = '\uF8DC'
const val DESTROYER_ICON = '\uF8DB'
const val CRUISER_ICON = '\uF8DA'
const val BATTLECRUISER_ICON = '\uF8D9'
const val SHUTTLE_ICON = '\uF8D8'
const val TRANSPORT_ICON = '\uF8D7'
const val LIGHT_FREIGHTER_ICON = '\uF8D6'
...
const val GAS_COLLECTOR_BACKGROUND_CHARACTER = '\uF8D1'
