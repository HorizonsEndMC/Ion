...
data class FrontierNationRole(
	override val _id: Oid<FrontierNation>,
	override val parent: Oid<FrontierNation>,
	override var name: String,
	override var color: SLTextStyleDB,
	override var weight: Int,
	override var permissions: MutableSet<Permission> = mutableSetOf(),
	override var members: MutableSet<SLPlayerId> = mutableSetOf()
) : Role<FrontierNation, FrontierNationRole.Permission>() {
	companion object : RoleCompanion<FrontierNation, Permission, FrontierNationRole>(
		FrontierNationRole::class,
		FrontierNationRole::parent,
		FrontierNationRole::name,
		FrontierNationRole::color,
		FrontierNationRole::permissions,
		FrontierNationRole::members,
		FrontierNationRole::weight,
		SLPlayer::frontierNation
	) {
		override fun new(parent: Oid<FrontierNation>, name: String, color: String, weight: Int): FrontierNationRole {
			return FrontierNationRole(objId(), parent, name, color, weight)
		}
	}
